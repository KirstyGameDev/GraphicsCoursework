...
bool MeshClass::InitializeBuffers(ID3D11Device* device)
{
	...
	//Set the number of normals in the normal array
	m_normalCount = 4;
	...
	vertices[0].position = D3DXVECTOR3(-1.0f, -1.0f, 2.0f);  // Bottom left.
	vertices[0].texture = D3DXVECTOR2(0.0f, 1.0f);
	vertices[0].normal = D3DXVECTOR3(0.5f, 0.5f, 0.5f);

	vertices[1].position = D3DXVECTOR3(-1.0f, 1.0f, 2.0f);  // Top left.
	vertices[1].texture = D3DXVECTOR2(0.0f, 0.0f);
	vertices[1].normal = D3DXVECTOR3(0.5f, 0.5f, 0.5f);
	
	vertices[2].position = D3DXVECTOR3(1.0f, 1.0f, 2.0f);  // Top right.
	vertices[2].texture = D3DXVECTOR2(1.0f, 0.0f);
	vertices[2].normal = D3DXVECTOR3(0.5f, 0.5f, 0.5f);

	vertices[3].position = D3DXVECTOR3(1.0f, -1.0f, 2.0f);  // Bottom right.
	vertices[3].texture = D3DXVECTOR2(1.0f, 1.0f);
	vertices[3].normal = D3DXVECTOR3(0.5f, 0.5f, 0.5f);
